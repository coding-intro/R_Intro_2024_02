...
.question[
How can we get from *messy* to *tidy* data?
]
...
- Goal for original data collection: Development of prediction models to classify a hotel booking's cancellation likelihood ([Antonia et al., 2019](https://www.sciencedirect.com/science/article/pii/S2352340918315191#bib5))
...
Once you're familiar with R and the Tidyverse, you can speed up your workflow with many shortcuts.
For example, you can insert a pipe (`%>%`) with:
...
.pull-left-wide[
.tip[
Find an overview of useful keyboard shortcuts in RStudio via
