...
Let's create a data visualization that displays how the voting record of West and East Germany developed before reunification and how the reunited Germany voted afterwards.
...
unvotes %>%
  filter(country %in% c("Germany", "German Democratic Republic", "Federal Republic of Germany")) %>%
