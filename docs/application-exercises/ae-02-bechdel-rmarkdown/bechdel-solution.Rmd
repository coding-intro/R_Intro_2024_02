---
title: "The Bechdel Test — Solution"
...
Don't worry, if you do not understand most parts of the code --- you'll get there soon.
...
There are `r bechdel90_13 %>% nrow()` such movies.
...
ggplot(data = bechdel90_13, mapping = aes(x = clean_test, y = roi, color = binary)) +
  geom_boxplot() +
  labs(title = "Return on investment vs. Bechdel test result",
       subtitle = "Zooming in for most relevant ROI values between 0 and 15", # Something about zooming in to a certain level
       x = "Detailed Bechdel result",
       y = "Return on investment",
       color = "Binary Bechdel result") +
